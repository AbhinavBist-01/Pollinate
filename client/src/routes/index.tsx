  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-4">
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-4">
        <Link to="/polls/new" className="rounded-xl bg-honey px-8 py-3 text-sm font-semibold text-white hover:bg-honey/90 transition-colors shadow-lg shadow-honey/20">
          Create a poll
        </Link>
        {!user ? (
          <Link to="/register" className="rounded-xl border border-white/15 px-8 py-3 text-sm font-medium text-white/70 hover:text-white hover:border-white/30 transition-colors">
            Create account
          </Link>
        ) : (
          <Link to="/dashboard" className="rounded-xl border border-white/15 px-8 py-3 text-sm font-medium text-white/70 hover:text-white hover:border-white/30 transition-colors">
            Dashboard
          </Link>
        )}
      </div>
