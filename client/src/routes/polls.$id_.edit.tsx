        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 space-y-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white focus:border-honey focus:outline-none focus:ring-1 focus:ring-honey"
              required
            />
          </div>
          <div className="space-y-1">
