    ...
    <div className="flex min-h-[80vh] items-center justify-center">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-orange mt-1">Get started with Pollinate</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            ...
            <input type="text" value={name} onChange={(e) => setName(e.target.value)}
              className="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm focus:border-honey focus:outline-none focus:ring-1 focus:ring-honey" placeholder="Your name" required />
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)}
              className="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm focus:border-honey focus:outline-none focus:ring-1 focus:ring-honey" placeholder="Min 6 characters" required minLength={6} />
          </div>
        ...
        <p className="text-center text-sm text-gray-500">Already have an account? <Link to="/login" className="text-orange hover:underline">Sign in</Link></p>
      </div>
    </div>
  )
}
